(ns dev.andylu.eelchat.app
  (:require [com.biffweb :as biff :refer [q]]
            [dev.andylu.eelchat.middleware :as mid]
            [dev.andylu.eelchat.ui :as ui]
            [dev.andylu.eelchat.settings :as settings]
            [rum.core :as rum]
            [xtdb.api :as xt]
...
(defn notify-clients [{:keys [dev.andylu.eelchat/chat-clients]} tx]
...
(defn ws-handler [{:keys [dev.andylu.eelchat/chat-clients] :as ctx}]
  {:status 101
