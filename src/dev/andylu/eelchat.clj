(ns dev.andylu.eelchat
  (:require [com.biffweb :as biff]
            [dev.andylu.eelchat.email :as email]
            [dev.andylu.eelchat.app :as app]
            [dev.andylu.eelchat.home :as home]
            [dev.andylu.eelchat.worker :as worker]
            [dev.andylu.eelchat.schema :as schema]
...
(defn on-save [ctx]
  ...
  (biff/eval-files! ctx)
  (generate-assets! ctx)
  (test/run-all-tests #"dev.andylu.eelchat.test.*"))
...
(def initial-system
  {:biff/plugins #'plugins
   ...
   :dev.andylu.eelchat/chat-clients (atom #{})})
